...
struct NodeTrack {
    ...
    static constexpr u16 kPitchYawRoll = 0x8000; ///< rotate pitch, yaw then roll; else roll, yaw, pitch
...
/** Decodes the keys of the entry at `info` ({u16 flags, u16 record size, u32 offset}) for a
