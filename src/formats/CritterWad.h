...
struct CritterDamageRecord {
    ...
    f32 maxSpeed = 0.0f;
    f32 gravity = 0.0f;
    f32 morphLife = 0.0f; ///< duration after the launch animation changes to its loop
    s16 sfxIndex = -1;
    s16 sfx = -1; ///< impact effect
    s16 morph = -1;
    s16 morphEnd = -1;
    f32 yawSpread = 0.0f;
};
...
struct CritterTypeRecord {
    ...
    f32 roamRadius = 0.0f; ///< TYPE +0xAC: boss home territory, not MOVE's units/second
