...
public:
    ...
    static constexpr std::array<std::string_view, kEnemyActionCount> kSequenceNames{
        "READY",      "START",       "TAUNT",       "WALK",        "RUN",
        "FLY",        "HOVER",       "LANDING",     "WALKTOREADY", "READYTOWALK",
        "WALKTOREADY", "READYTOWALK", "ATTACK1",    "ATTACK1R",    "ATTACK2",
        "ATTACK2R",   "ATTACK3",     "ATTACK3R",    "ATTACK4",     "ATTACK4R",
        "ATTACK5",    "ATTACK5R",    "RUNATTACK1",  "RUNATTACK2",  "THROW1",
        "THROW2",     "THROWF",      "ATTTOREADY",  "HIT1",        "HIT2",
        "HIT3",       "GETUP",       "DEATH"};
    ...
    bool attacking() const { return m_current >= Action::Attack && m_current <= Action::ThrowToReady; }
